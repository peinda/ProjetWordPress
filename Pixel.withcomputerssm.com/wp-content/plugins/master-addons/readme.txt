...
3. [Advanced Accordion](https://master-addons.com/demos/advanced-accordion/)
4. [Tabs](https://master-addons.com/demos/tabs/)
5. [Progressbar](https://master-addons.com/demos/progress-bar/)
6. [Progressbars](https://master-addons.com/demos/multiple-progress-bars/)
7. [Tooltips](https://master-addons.com/demos/tooltip/)
8. [Flip Box](https://master-addons.com/demos/flipbox/)
...
2. [Ninja Forms](https://master-addons.com/demos/ninja-form/)
...
= EXPERT SUPPORT =
We have an excellent and friendly support team for your assistance. Put your question in the [Facebook Group](https://www.facebook.com/groups/2495256720521297/) or you can contact us directly via live chat and [contact form](https://master-addons.com/contact-us/).
...
.org/support/plugin/master-addons) and 2. [Contact Support](https://master-addons.com/contact-us/). Since, this is a Free Plugin, Support reply may delay for answer
...
3. 40+ Widgets Elements
4. MA Blog Settings and Preview
5. 12+ Style Variations Contact Forms
6. MA Animated Headlines
7. MA Progressbars
8. MA Gradient Accordion
9. MA Tabs
