		...
		$controls->start_controls_section(
			...
			$controls->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .stratum-advanced-tabs .stratum-advanced-tabs__icon' => 'font-size: {{SIZE}}{{UNIT}}',
					],
				]
			);
					...
					$controls->add_control(
						...
						[
							...
							'selectors' => [
								...
								'{{WRAPPER}} .stratum-advanced-tabs .stratum-advanced-tabs__navigation-item .stratum-advanced-tabs__icon > span > svg > path' => 'fill: {{VALUE}}',
							],
						]
					);
					...
					$controls->add_control(
						...
						[
							...
							'selectors' => [
								...
								'{{WRAPPER}} .stratum-advanced-tabs .stratum-advanced-tabs__navigation-item.active-nav .stratum-advanced-tabs__icon > span > svg > path' => 'fill: {{VALUE}}',
							],
						]
					);
					...
					$controls->add_control(
						...
						[
							...
							'selectors' => [
								...
								'{{WRAPPER}} .stratum-advanced-tabs .stratum-advanced-tabs__navigation-item:hover .stratum-advanced-tabs__icon > span > svg > path' => 'fill: {{VALUE}}',
							],
						]
					);
