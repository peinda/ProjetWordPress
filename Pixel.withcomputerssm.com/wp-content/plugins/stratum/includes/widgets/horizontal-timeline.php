...
class Horizontal_Timeline extends Stratum_Widget_Base {
				...
				$controls->start_controls_tab(
					...
					$controls->add_responsive_control(
						...
						[
							...
							'selectors'  => [
								'{{WRAPPER}} .stratum-horizontal-timeline-item__point-content--icon' => 'font-size: {{SIZE}}{{UNIT}};'
							]
						]
					);
				...
				$controls->start_controls_tab(
					...
					$controls->add_control(
						...
						[
							...
							'type'      => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .stratum-horizontal-timeline-item:hover .stratum-horizontal-timeline-item__point-content' => 'border-color: {{VALUE}};'
							],
							'condition' => [
								'point_border_border!' => ''
							]
				...
				$controls->start_controls_tab(
					...
					$controls->add_control(
						...
						[
							...
							'type'  => Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .stratum-horizontal-timeline-item.is-active .stratum-horizontal-timeline-item__point-content' => 'border-color: {{VALUE}};'
							],
							'condition' => [
								'point_border_border!' => ''
							]
	...
	public function _get_timeline_image($class, $item) {
		...
		$out .= "<div class='".esc_attr( $class.'-item__card-image' )."'>";
			$out .= "<img src='".(empty( $id ) ? Utils::get_placeholder_image_src() : esc_url( $url )." wp-image-".esc_attr($id)."' srcset='".$srcset)."'/>";
		$out .= "</div>";
	...
	public function _generate_point_content($class, $item, $index) {
		...
		$icon_class = $item[ 'item_point_icon' ][ 'value' ];
	...
	public function _generate_card_content($class, $item, $settings, $title_html_tag) {
		$out = "";
