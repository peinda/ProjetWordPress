...
class Image_Accordion extends Stratum_Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $controls->add_responsive_control(
            ...
            [
                ...
                'selectors'   => [
                    '{{WRAPPER}} .stratum-image-accordion__overlay' => ' align-items: {{VALUE}};'
                ]
            ]
        );
		...
		$controls->start_controls_section(
			...
			$controls->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .stratum-stratum-image-accordion__button'
				]
			);
	...
	public function image_accordion_render_button($button_text, $link) {
		$out = '';
