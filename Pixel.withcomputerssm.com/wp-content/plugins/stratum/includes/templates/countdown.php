...
$countdown_options = array(
	...
	((!$is_editor && !empty( $settings['expire_actions'] )) ? "data-expire-actions='".json_encode($expire_actions)."'" : '' ),
	((!$is_editor && is_array($expire_actions) && in_array("redirect", $expire_actions) && $expire_redirect_url['url'] != '') ? "data-expire-url='".esc_url($expire_redirect_url['url'])."'" : '' ),
	((!$is_editor && is_array($expire_actions) && in_array("message", $expire_actions) && $message_after_expire != '') ? "data-expire-text='".$message_after_expire."'" : '' )
);
