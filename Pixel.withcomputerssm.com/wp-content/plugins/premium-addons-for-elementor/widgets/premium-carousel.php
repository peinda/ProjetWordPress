		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-carousel-wrapper .slick-arrow svg, {{WRAPPER}} .premium-carousel-wrapper .slick-arrow svg g path' => 'fill: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .premium-carousel-wrapper .slick-arrow:hover svg, {{WRAPPER}} .premium-carousel-wrapper .slick-arrow:hover svg g path' => 'fill: {{VALUE}};',
				),
			)
		);
