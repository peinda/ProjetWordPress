...
class Premium_Pricing_Table extends Widget_Base {
	...
	protected function _register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->add_control(
			'premium_pricing_table_button_link_target',
			array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .premium-pricing-feature-icon' => 'margin-' . $features_spacing . ': {{SIZE}}px',
				),
			)
		);
	...
	<div class="premium-pricing-table-container">
		...
		<div class="premium-pricing-description-container">
			...
			<?php echo wp_kses_post( $settings['premium_pricing_table_description_text'] ); ?>
			</div>
		</div>
		<?php endif; ?>
