...
use PremiumAddons\Modules\Premium_Equal_Height\Module;
...
class Addons_Integration {
	...
	public function __construct() {
		...
		if ( self::$modules['premium-equal-height'] ) {
			...
			add_action( 'elementor/editor/after_enqueue_scripts', array( $this, 'eh_editor_script' ) );
		}
	...
	/**
	 * Loads Equal Height Editor script
	 *  	
	 * @access public
	 * @return void
	 */
	public function eh_editor_script() {
	...
	public function register_frontend_scripts() {
		...
		wp_localize_script(
			...
			'PaModulesSettings',
			array(
				'equalHeight_url' => PREMIUM_ADDONS_URL . 'assets/frontend/' . $dir . '/premium-eq-height' . $suffix . '.js',
			)
		);
	...
	public function init_pa_controls() {
		...
		\Elementor\Plugin::instance()->controls_manager->register_control( $premium_select::TYPE, new $premium_select() );
